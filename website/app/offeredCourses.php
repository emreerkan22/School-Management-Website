            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    if (!$conn) {
                        ...
                        $sql = "SELECT DISTINCT course_name,course_id FROM course";
                        $result = mysqli_query($conn, $sql);
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<div class="col-md-6 col-lg-6 col-xlg-4">' .
                                    ...
                                    '<h3 class="box-title m-b-0">' . ucfirst($row['course_name']) . ' *' . $row['course_id'] . '</h3>' .
                                    '<p>Please click Register button to take the course. </p>' .
                                    '<form method="POST"><button type="submit" class="btn btn-rounded btn-success" name="register" value="' . $row['course_id'] . '">Register</button> </form>' .
                                    ' </div>' .
                                    '</div>' .
                                    '</div>' .
                                    '</div>';
